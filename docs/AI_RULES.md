...
- aucune IA ne modifie MCP sans respecter MCP_SPEC.md ;
- aucune IA ne modifie REST sans respecter API_SPEC.md ;
- aucune IA ne modifie le modèle de données sans respecter DATABASE.md ;
- aucune IA ne modifie la crypto sans respecter CRYPTOGRAPHY.md ;
- aucune IA ne modifie la sécurité sans respecter SECURITY.md ;
- aucune IA ne modifie l'architecture sans respecter ARCHITECTURE.md ;
